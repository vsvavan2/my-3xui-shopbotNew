...
Для стандартного обновления (если вы уже используете этот репозиторий):

```bash
curl -sSL https://raw.githubusercontent.com/vsvavan2/my-3xui-shopbot/main/install.sh | sudo bash
```

**Если вы обновляетесь с другой версии бота или другого репозитория:**
См. подробную инструкцию: [UPDATE_INSTRUCTIONS.md](UPDATE_INSTRUCTIONS.md)
